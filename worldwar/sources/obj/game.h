...
public:
    ...
    void creatureDeath(Creature* attacker, Creature* creature);
    void addBlood(Creature* attackedCreature, Position& bloodPos, bool dead);
    void addCorpse(Tile* tile, Creature* attacker,  Creature* attackedCreature);
...
protected:
    ...
    void onCreatureDeath(Tile* tile, Creature *attacker, Creature* attackedCreature, int damage, bool drawBlood);
	Game *game;
