...
piece1pos = {x=609, y=524, z=6, stackpos=1}
piece2pos = {x=613, y=524, z=6, stackpos=1}
piece3pos = {x=608, y=525, z=6, stackpos=1}
piece4pos = {x=614, y=525, z=6, stackpos=1}
piece5pos = {x=609, y=527, z=6, stackpos=1}
piece6pos = {x=611, y=527, z=6, stackpos=1}
piece7pos = {x=613, y=527, z=6, stackpos=1}
helmetpos = {x=611, y=524, z=6, stackpos=1}
...
if item.uid == 1337 and item.itemid == 1945 and getpiece1.itemid == 2335 and getpiece2.itemid == 2336 and getpiece3.itemid == 2337 and getpiece4.itemid == 2338 and getpiece5.itemid == 2339 and getpiece6.itemid == 2340 and getpiece7.itemid == 2341 then
